angular.module('D2DAPP')
  ...
  //=========================================================================
  .config(['$stateProvider', '$urlRouterProvider', 'localStorageServiceProvider', 'growlProvider', '$httpProvider',
    function ($stateProvider, $urlRouterProvider, localStorageServiceProvider, growlProvider, $httpProvider) {
